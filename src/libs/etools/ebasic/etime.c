...
static inline int __hrtime_init()
{
    ...
    __hrtime_nsec_offset = (i64)t1.tv_sec * 1000000000ll + (i64)t1.tv_nsec - (i64)t2.tv_sec * 1000000000ll + (i64)t2.tv_nsec;
...
static inline u64 __hrtime_ns(clocktype_t type)
{
    ...
    clock_id = (type == _CLOCK_FAST) ? __fast_real_id : CLOCK_REALTIME;
...
static inline u64 __hrtick_ns(clocktype_t type)
{
    ...
    clock_id = (type == _CLOCK_FAST) ? __fast_mono_id : CLOCK_MONOTONIC;
...
i64  e_nowus()  { return __hrtime_ns(_CLOCK_FAST   ) / 1000      ; }
...
i64  e_tickus() { return __hrtick_ns(_CLOCK_FAST   ) / 1000      ; }

...
macro(ETestAddTestSet i_name)
    ...
    set(_type Auto)
    if(NOT M_TYPE)
    elseif(NOT ${M_TYPE} MATCHES "^Unit|Module|Auto|Benchmark$")
        EMakeErrF("ETestAddTestSet(): invalid type of '${M_TYPE}', you can only set 'Auto', 'Unit', 'Module' or 'Benchmark' of TYPE when adding a test")
    else()
        set(_type ${M_TYPE})
    endif()
    set(M_TYPE ${_type})

    if(M_TYPE STREQUAL "Benchmark")
